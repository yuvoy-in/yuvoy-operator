  ...
  return (
    <main className="bg-cream text-forest min-h-dvh">
      <div className="container-page max-w-2xl py-8">
        ...
        */}
        {!isOwner ? (
          <p className="rounded-edge border-cream-line bg-cream-deep mt-6 border p-4 text-sm">
        ...
        <section className="mt-12" aria-labelledby="why">
          ...
          <div className="rounded-edge border-cream-line bg-cream-deep mt-3 border p-5">
            ...
            <p className="text-forest/80 mt-3 text-sm">
              ...
              manager login plus one convincing phone call is otherwise enough
              to redirect a season&rsquo;s takings.
            </p>
            <p className="text-forest/80 mt-3 text-sm">
              ...
              &ldquo;we removed them&rdquo; and &ldquo;we removed them a
              fortnight from now&rdquo;, and the reason somebody is removed in a
              hurry is usually that the fortnight matters.
            </p>
          </div>
        </section>
      </div>
