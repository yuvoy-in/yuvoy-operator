...
/**
 * Help for Today (Home in code), the tab bar and the header.
 *
...
export const HOME_HELP: readonly HelpTopic[] = [
  {
    id: "selling-line",
    area: "Today",
    question: "What does the line at the top of Today mean?",
    answer: [
  ...
  },
  {
    ...
    answer: [
      ...
      "Confirm all on Today confirms every departure in the next 12 months, on every listing, and changes no seat counts. A listing's own page confirms just that listing's. You also get an email once a day listing any departures that are off sale or about to go off sale, unless you turn it off in your notifications.",
    ],
  },
  {
    id: "no-dates-to-sell",
  ...
  },
  {
    ...
    area: "Today",
    question: "Why is a departure missing from Today?",
    answer: [
      "Today lists the departures somebody could be on. A called-off departure is left out, because every booking on it was cancelled. So is a departure on a listing that has never been on sale, and one closed to new bookings with nobody booked on it.",
  ...
  },
  {
    id: "money-line",
    area: "Today",
    question: "What does the money line on Today say?",
    answer: [
